  ...
  return (
    <div className='h-[100vh] flex items-center justify-center'>
      <div className="shadow-[0_1px_5px_2px_rgba(0,0,0,0.3)] mx-0 my-auto flex items-center justify-center flex-col p-[50px] rounded-[10px] w-[450px]">
        ...
        <p><b>Sign up to join with Stack</b></p>
        <form onSubmit={handleSubmit} className='flex flex-col w-full p-[15px] gap-y-8' method='POST'>
            ...
            <button type="submit" className='bg-violet-500 hover:bg-violet-600 focus:outline-none focus:ring focus:ring-violet-300 active:bg-violet-700 py-[10px] px-[25px] text-sm leading-5 rounded-[6px] font-semibold text-white'>Sign Up</button>
        </form>
        <span className="text-slate-500">Already have an account? <Link to="/login" className='text-blue-600 visited:text-purple-600'>Sign In</Link></span>
      </div>
    </div>
  )
}
